...
You are running the midday scan workflow. Credentials come from the local .env file.
...
STEP 6 — Optional intraday research via Perplexity (or WebSearch) if something is moving
